...
event_a_repl = Vector{MemoryTrace}([trace_replication(event_a, 0.75) for _ in 1:5])
...
event_b_repl = Vector{MemoryTrace}([trace_replication(event_b, 0.75) for _ in 1:5])
...
event_c_repl = Vector{MemoryTrace}([trace_replication(event_c, 0.75) for _ in 1:5])
...
event_d_repl = Vector{MemoryTrace}([trace_replication(event_d, 0.75) for _ in 1:5])
